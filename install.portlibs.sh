...
_PORTLIBS+=("sftd");           _PORTLIBS_FILE+=("libsftd.a");          _PORTLIBS_LINK+=("https://github.com/Naxann/3ds_portlibs/releases/download/v1.0/sftd-c5aa104.tar.gz");         _PORTLIBS_FILE_EMU+=("");                  _PORTLIBS_FILE_H_EMU+=("");                          _PORTLIBS_DPKG+=("");
_PORTLIBS+=("sf2d");           _PORTLIBS_FILE+=("libsf2d.a");          _PORTLIBS_LINK+=("https://github.com/Naxann/3ds_portlibs/releases/download/v1.0/sf2d-9c183f6.tar.gz");         _PORTLIBS_FILE_EMU+=("");                  _PORTLIBS_FILE_H_EMU+=("");                          _PORTLIBS_DPKG+=("");
_PORTLIBS+=("sfil");           _PORTLIBS_FILE+=("libsfil.a");          _PORTLIBS_LINK+=("https://github.com/Naxann/3ds_portlibs/releases/download/v1.0/sfil-6f32002.tar.gz");         _PORTLIBS_FILE_EMU+=("");                  _PORTLIBS_FILE_H_EMU+=("");                          _PORTLIBS_DPKG+=("");
